...
/**
 * Servlet implementation class CustomersMessage
 */
...
public class CustomersMessage extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String htmlTextMessage = "" + "<html>" + "<body>"
				...
				+ "Customers Message Received !!<br/><br/> Name: " + name + "," + "<br/><br/> Email Id: " + email
				...
				+ "</body>" + "</html>";
		String message = MailMessage.sendMessage("ellison.alumni@gmail.com", "Customers Message | " + name + " | " + email,
				htmlTextMessage);
